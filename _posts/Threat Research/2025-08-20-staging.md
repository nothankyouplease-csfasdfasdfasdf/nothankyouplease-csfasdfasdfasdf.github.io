...
| from_user_id | username | COUNTA of original_message |
|--------------|----------|----------------------------|
...
2 members chatting "250k cargo" and asking "do we have an MC with 250k cargo?". Here they are refereing to a compromised Motor Carrier with 250k worth of cargo. Although the currency is not stated - we presume they are discussing USD as they are targeting US companies. 
